      ...
      <LAYOUT>
        <main role="main">
          <section class="jumbotron text-center">
            ...
            <div class="col-sm">
              <h1>Cat Info</h1>
              <button class="btn-group btn-lg btn-info" id="catfed" type="submit">Fed</button>
              <button class="btn-group btn-lg btn-info" id="catfollow" type="submit">Followers</button>
              <hr/>
